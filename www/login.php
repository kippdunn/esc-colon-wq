<?php $title = 'Login to play!'; include("templates/header.php"); ?>
		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-login">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<form id="login-form" action="login/process.php" method="post" role="form" style="display: block;">
							...
							<form id="register-form" action="register/process.php" method="post" role="form" style="display: none;">
								<div class="form-group">
									<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="Username"
									 value="">
								</div>
